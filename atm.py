class Bank_Account:
    def __init__(self):
        self.balance = 0
        print("Hello!!! Welcome to a Virtual Deposit & Withdrawal Machine")
        self.card_number = float(int(input("Plzz Provide Your Card Number : ")))
        self.pin_number = float(int(input("Plzz Provide Your Pin Number : ")))
